...
@Component({
  selector: 'app-modal-revisa-new-baja',
  templateUrl: './modal-revisa-new-baja.component.html',
  styleUrls: ['./modal-revisa-new-baja.component.css']
})
export class ModalNewBajaComponent {
